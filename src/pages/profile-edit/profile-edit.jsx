...
function ProfileEdit() {
    ...
    const submitCallback = useCallback((state) => {
    ...
    const changeValue = (user.name !== "" && (state.name !== user.name || state.email !== user.email || state.password.length > 0));
    ...
    return (
        <form className="page-container-inner" onSubmit={onSubmit} onReset={onReset}>
            ...
            {requestStart ? <Loader /> : changeValue ? (<div>
