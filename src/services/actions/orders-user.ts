import { TOrdersList } from '../../utils/type';

export const ORDERS_USER_START:"ORDERS_USER_START" = "ORDERS_USER_START";
export const ORDERS_USER_OPEN:"ORDERS_USER_OPEN" = "ORDERS_USER_OPEN";
export const ORDERS_USER_END:"ORDERS_USER_END" = "ORDERS_USER_END";
export const ORDERS_USER_SUCCESS:"ORDERS_USER_SUCCESS" = "ORDERS_USER_SUCCESS";
export const ORDERS_USER_ERROR:"ORDERS_USER_ERROR" = "ORDERS_USER_ERROR";
export const ORDERS_USER_CLOSED:"ORDERS_USER_CLOSED" = "ORDERS_USER_CLOSED";
export const ORDERS_USER_MESSAGE:"ORDERS_USER_MESSAGE" = "ORDERS_USER_MESSAGE";
